...
OnlyWire is the only service which auto-submits content to multiple sites simultaneously.  AddThis and ShareThis only allow readers to submit to one site at a time.  OnlyWire has built this submission technology from the ground up, and we are constantly making improvements to streamline the process for users wordwide.  Hundreds of thousands of bloggers and publishers depend on OnlyWire to drive traffic and syndicate content.
...
* Fixed bug when no tags were associated with a post
